...
! Laita spamname aakkosjärjestykseen ja anna sille nimi my_spamcrops (ehkä upper suoraan=
! Sitte yhdistele tää nutritiens kanssa
...
# ------------------------------------------------ fao nutritients
# https://view.officeapps.live.com/op/view.aspx?src=https%3A%2F%2Fwww.fao.org%2Ffileadmin%2Ftemplates%2Fess%2Fess_test_folder%2FFood_security%2FExcel_sheets%2FNutritive_Factors.xls&wdOrigin=BROWSELINK
...
nutritients_crop <- nutritients %>% 
  ...
  ## try to combine this nutritients to fbs data
