...
names(r_combined_protein_plots) <- c("prot_kgha", "prot_kgha_clmask", "prot_kgha_outside_cl")
...
tmap_save(plts_combined_prot_and_shares, filename = here("Figures", "plts_combined_prot_and_shares.pdf"))
```
