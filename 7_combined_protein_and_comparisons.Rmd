...
plot(r_share_of_total_protein_livestock, 
     main = "Contribution of livestock to total protein production")
...
plot(SI_5arcmin_range_1to10, main = "SI below 10")
...
plot(r_share_of_total_protein_livestock_SIbetween1to10mask)
...
r_protein_combined_kg_ha <-
  mask(r_protein_combined_kg_ha, r_fraction_gl_cl_total_0toNA)
...
r_protein_combined_kg_ha_SIbetween1to10mask <-
  mask(r_protein_combined_kg_ha,
       SI_5arcmin_range_1to10)
plot(r_protein_combined_kg_ha_SIbetween1to10mask)
...
global(r_protein_combined_kg_perpix, "sum", na.rm = T)/1e9 # 285 mmt
...
r_protein_combined_kg_perpix_wheremixed <-
  mask(r_protein_combined_kg_perpix, 
       r_gl_cl_share_mixed)
global(r_protein_combined_kg_perpix_wheremixed, "sum", na.rm = T)/1e9 # 170
...
# Total combined protein on croplands where 1< SI < 10
r_protein_combined_kg_perpix_SIbetween1to10mask <-
  mask(r_protein_combined_kg_perpix, 
       SI_5arcmin_range_1to10)
global(r_protein_combined_kg_perpix_SIbetween1to10mask, "sum", na.rm = T)/1e9 # 4.3
...
create_index_map(r_index = r_share_of_total_protein_livestock_mixed , 
                     tocrs = "ESRI:54030",
                     index_main_title = "Share of livestock MIXED",
                     index_label = "[%]",
                     colorpal = pal_share,
                     colorNA = "NA",
...
#             overwrite = TRUE)
writeRaster(r_protein_combined_kg_ha_SIbetween1to10mask,
            filename = here("Data", "Intermediate_input", "r_protein_combined_kg_ha_SIbetween1to10mask.tif"),
            overwrite = TRUE)
...
writeRaster(r_share_of_total_protein_livestock_SIbetween1to10mask,
            filename = here("Data", "Intermediate_input", "r_share_of_total_protein_livestock_SIbetween1to10mask.tif"),
            overwrite = TRUE)
