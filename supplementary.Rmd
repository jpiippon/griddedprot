...
r_fraction_gl_HYDE_0toNA <- classify(r_fraction_gl_HYDE, cbind(0,NA))

r_fractions_cl_gl_and_total <- c(
  r_fraction_gl_HYDE_0toNA,
  r_fraction_cl_0toNA,
  r_fraction_gl_0toNA, # r_fraction_hyde_grazing_lands_masked_to_MODIS_IGBP_areas_0toNA.tif
  r_fraction_gl_cl_total_0toNA # this must be changed as well!
)

names(r_fractions_cl_gl_and_total) <- c(
  "Share of HYDE grazing land in cell",
  "Share of cropland in cell", 
  "Share of grazing land in this study",
...
(plt_shares_of_croplands_and_grazing_lands <- 
...
tmap_save(plt_shares_of_croplands_and_grazing_lands,
