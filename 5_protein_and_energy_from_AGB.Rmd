...
plot(r_protein_from_065xAGB_kg_ha, main = "protein from AGB when 65% of AGB is used ") 
...
r_kcal_animals_MM_perpix <- 
  ...
  r_fraction_gl
global(r_kcal_animals_MM_perpix*1e6, fun = "sum", na.rm = T)/1e12 # dairy 328 beef 73 sheep 111
